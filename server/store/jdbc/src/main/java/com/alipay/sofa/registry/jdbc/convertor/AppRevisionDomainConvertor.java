...
public class AppRevisionDomainConvertor {
    ...
    public static final TypeReference BASE_FORMAT    = new TypeReference<HashMap<String, List<String>>>() {
                                                     };
    public static final TypeReference SERVICE_FORMAT = new TypeReference<HashMap<String, AppRevisionInterface>>() {
                                                     };

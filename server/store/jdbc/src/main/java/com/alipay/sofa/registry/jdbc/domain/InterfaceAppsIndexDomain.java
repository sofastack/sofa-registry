 ...
 * 
 * @author xiaojian.xj
 * @version $Id: InterfaceAppsIndexDomain.java, v 0.1 2021年01月24日 17:05
 *          xiaojian.xj Exp $
 */
public class InterfaceAppsIndexDomain {
	...
	public InterfaceAppsIndexDomain(String dataCenter, String interfaceName,
			String appName) {
	 ...
	 * 
	 * @param reference
	 *            value to be assigned to property reference
	 */
	 ...
	 * 
	 * @param gmtModify
	 *            value to be assigned to property gmtModify
	 */
	 ...
	 * 
	 * @param hashcode
	 *            value to be assigned to property hashcode
	 */

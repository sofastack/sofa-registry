...
public interface InterfaceAppsIndexMapper {
     ...
     * @return
     */
    public List<InterfaceAppsIndexDomain> queryByInterfaceName(@Param("dataCenter") String dataCenter,
     ...
     * @return
     */
    public List<InterfaceAppsIndexDomain> batchQueryByInterface(List<InterfaceAppIndexQueryModel> querys);
     ...
     * @returns
     */
    List<InterfaceAppsIndexDomain> queryModifyAfterThan(@Param("dataCenter") String dataCenter,
     ...
     * @returns
     */
    List<InterfaceAppsIndexDomain> queryModifyEquals(@Param("dataCenter") String dataCenter,
                                                     @Param("maxUpdate") Timestamp maxUpdate);

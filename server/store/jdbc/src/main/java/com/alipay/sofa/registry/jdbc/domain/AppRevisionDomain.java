...
public class AppRevisionDomain {
	 ...
	 * 
	 * @param revision
	 *            value to be assigned to property revision
	 */
	 ...
	 * 
	 * @param baseParams
	 *            value to be assigned to property baseParams
	 */
	 ...
	 * 
	 * @param serviceParams
	 *            value to be assigned to property serviceParams
	 */
	 ...
	 * 
	 * @param clientVersion
	 *            value to be assigned to property clientVersion
	 */

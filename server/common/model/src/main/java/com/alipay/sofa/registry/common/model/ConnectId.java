...
public final class ConnectId implements Serializable {
    ...
    public ConnectId(@JsonProperty("clientHostAddress") String clientHostAddress,
    ...
    public static ConnectId of(String clientAddress, String sessionAddress) {
        ...
        return new ConnectId(clientURL.getIpAddress(), clientURL.getPort(),
            sessionURL.getIpAddress(), sessionURL.getPort());
    }

    public static ConnectId of(InetSocketAddress clientAddress, InetSocketAddress sessionAddress) {
        return new ConnectId(clientAddress.getAddress().getHostAddress(), clientAddress.getPort(),
            sessionAddress.getAddress().getHostAddress(), sessionAddress.getPort());
    }
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof ConnectId))
            return false;
        ConnectId connectId = (ConnectId) o;
        return clientPort == connectId.clientPort && sessionPort == connectId.sessionPort
    ...
    public String toString() {
        ...
        sb.append(clientHostAddress).append(URL.COLON).append(clientPort)
            .append(ValueConstants.CONNECT_ID_SPLIT).append(sessionHostAddress).append(URL.COLON)
            .append(sessionPort);
        return sb.toString();
    }
}

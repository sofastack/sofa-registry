...
public class CompressKeyTest {
  ...
  public void testPushKey() {
    ...
    CompressPushKey key1 = CompressPushKey.of(receivedData.getSegment(), receivedData.getDataId(), receivedData.getInstanceId(),
            receivedData.getGroup(), receivedData.getVersion(), receivedData.getData(), "zstd");
    CompressPushKey key2 = CompressPushKey.of(receivedData.getSegment(), receivedData.getDataId(), receivedData.getInstanceId(),
            receivedData.getGroup(), receivedData.getVersion(), receivedData.getData(), "zstd");
    Assert.assertEquals(key1, key2);
    Assert.assertEquals(key1.hashCode(), key2.hashCode());
    Assert.assertNotNull(key1.toString());
    ...
    CompressPushKey key3 = CompressPushKey.of(receivedData.getSegment(), receivedData.getDataId(), receivedData.getInstanceId(),
            receivedData.getGroup(), receivedData.getVersion(), receivedData.getData(), "zstd");
    Assert.assertNotEquals(key1, key3);
  }
}

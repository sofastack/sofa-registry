...
public class PropertySplitterTest {
    ...
    public void testMapOfList() {
        ...
        Assert.assertEquals(2,
            propertySplitter.mapOfList("KEY1:VALUE1.1,VALUE1.2|KEY2:VALUE2.1,VALUE2.2").size());
        Assert.assertTrue(propertySplitter.map("KEY1:VALUE1,KEY2:VALUE2").get("KEY1")
            .contains("VALUE1"));
        Assert.assertTrue(propertySplitter.map("KEY1:VALUE1,KEY2:VALUE2").get("KEY2")
            .contains("VALUE2"));
    }
    ...
    public void testGroupedList() {
        ...
        Assert.assertEquals(2, propertySplitter.groupedList("VALUE1.1,VALUE1.2|VALUE2.1,VALUE2.2")
            .size());
        Assert.assertTrue(((List) (((List) propertySplitter
            .groupedList("VALUE1.1,VALUE1.2|VALUE2.1,VALUE2.2")).get(0))).contains("VALUE1.1"));
        Assert.assertTrue(((List) (((List) propertySplitter
            .groupedList("VALUE1.1,VALUE1.2|VALUE2.1,VALUE2.2")).get(0))).contains("VALUE1.1"));
        Assert.assertTrue(((List) (((List) propertySplitter
            .groupedList("VALUE1.1,VALUE1.2|VALUE2.1,VALUE2.2")).get(1))).contains("VALUE2.1"));
        Assert.assertTrue(((List) (((List) propertySplitter
            .groupedList("VALUE1.1,VALUE1.2|VALUE2.1,VALUE2.2")).get(1))).contains("VALUE2.2"));
    }
}

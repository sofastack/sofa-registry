...
public class LifecycleHelper {
	...
	public static void initializeIfPossible(Object obj)
			throws InitializeException {

		if (obj instanceof Lifecycle
				&& ((Lifecycle) obj).getLifecycleState().canInitialize()) {
	...
	public static void startIfPossible(Object obj) throws StartException {
		...
		if (obj instanceof Lifecycle
				&& ((Lifecycle) obj).getLifecycleState().canStart()) {
			((Lifecycle) obj).start();
		}
	...
	public static void stopIfPossible(Object obj) throws StopException {
		...
		if (obj instanceof Lifecycle
				&& ((Lifecycle) obj).getLifecycleState().canStop()) {
			((Lifecycle) obj).stop();
		}
	}
	...
	public static void disposeIfPossible(Object obj) throws DisposeException {
		if (obj instanceof Lifecycle
				&& ((Lifecycle) obj).getLifecycleState().canDispose()) {

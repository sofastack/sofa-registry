...
public interface Client extends Endpoint {
	 ...
	 *            the timeout millis
	 */
	void sendCallback(final URL url, final Object message,
			CallbackHandler callbackHandler, final int timeoutMillis);
	 ...
	 * @return object
	 */
	Object sendSync(final Channel channel, final Object message,

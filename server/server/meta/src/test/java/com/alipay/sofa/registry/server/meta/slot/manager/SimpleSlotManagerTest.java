...
public class SimpleSlotManagerTest extends AbstractMetaServerTest {
    ...
    public void testRefresh() {
        ...
        Assert.assertFalse(slotManager.getDataNodeManagedSlot(dataNodes.get(0).getIp(), false).getLeaders()
            .isEmpty());
        Assert.assertTrue(slotManager.getDataNodeManagedSlot(dataNodes.get(0).getIp(), true).getFollowers()
            .isEmpty());
    }

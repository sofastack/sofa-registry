 ...
 * Jan 18, 2021
 */
public class DataServerFollowerSizeComparator implements Comparator<String> {
    ...
    public int compare(String dataServer1, String dataServer2) {
        ...
        int score = dataNodeSlot1.getFollowers().size() - dataNodeSlot2.getFollowers().size();
        if (score == 0) {
            score = dataNodeSlot1.getLeaders().size() - dataNodeSlot2.getLeaders().size();
        }

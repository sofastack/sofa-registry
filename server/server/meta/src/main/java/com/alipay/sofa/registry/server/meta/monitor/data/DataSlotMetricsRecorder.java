...
public class DataSlotMetricsRecorder implements SlotTableRecorder {
    ...
    public void record(SlotTable slotTable) {
        ...
        dataNodeSlots.forEach(dataNodeSlot -> {
            Metrics.DataSlot.setLeaderNumbers(dataNodeSlot.getDataNode(), dataNodeSlot.getLeaders().size());
            Metrics.DataSlot.setFollowerNumbers(dataNodeSlot.getDataNode(), dataNodeSlot.getFollowers().size());
        });
    }
}

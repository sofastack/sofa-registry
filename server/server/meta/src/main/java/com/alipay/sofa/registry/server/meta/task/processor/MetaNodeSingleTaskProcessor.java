 ...
 */
public class MetaNodeSingleTaskProcessor implements TaskProcessor<MetaServerTask> {

    private static final Logger LOGGER = LoggerFactory.getLogger(MetaNodeSingleTaskProcessor.class,
                                           "[Task]");
    ...
    public ProcessingResult process(MetaServerTask task) {
        try {
            ...
            LOGGER.error("Meta node SingleTask Process error!", throwable);

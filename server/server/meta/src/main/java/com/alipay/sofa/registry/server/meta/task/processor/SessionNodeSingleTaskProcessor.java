 ...
 *
 * @author shangyu.wh
 * @version $Id: SessionNodeSingleTaskProcessor.java, v 0.1 2018-01-15 16:42 shangyu.wh Exp $
 */
public class SessionNodeSingleTaskProcessor implements TaskProcessor<MetaServerTask> {

    private static final Logger LOGGER = LoggerFactory.getLogger(
                                           SessionNodeSingleTaskProcessor.class, "[Task]");
    ...
    public ProcessingResult process(MetaServerTask task) {
        try {
            ...
            LOGGER.error("Session node SingleTask Process error!", throwable);

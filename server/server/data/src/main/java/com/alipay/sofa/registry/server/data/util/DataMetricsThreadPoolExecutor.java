 ...
 */
public class DataMetricsThreadPoolExecutor extends ThreadPoolExecutor {

    private static final Logger LOGGER = LoggerFactory
                                           .getLogger(DataMetricsThreadPoolExecutor.class);

    private String              executorName;

    public DataMetricsThreadPoolExecutor(String executorName, int corePoolSize,

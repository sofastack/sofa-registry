...
public class LocalDatumStorageTest {
    ...
    public void testPut() {
        ...
        Assert.assertEquals(summaryMap.get(publisher.getDataInfoId()).getDataInfoId(),
            publisher.getDataInfoId());
        Assert.assertEquals(
            summaryMap.get(publisher.getDataInfoId()).getPublisherVersions().size(), 1);
        Assert.assertEquals(
    ...
    public void testRemove() {
        ...
        DatumVersion v = storage
            .remove(publisher.getDataInfoId(), publisher2.getSessionProcessId());
        Assert.assertNotNull(v);
        ...
        v = storage.remove(publisher3.getDataInfoId(), publisher3.getSessionProcessId(),

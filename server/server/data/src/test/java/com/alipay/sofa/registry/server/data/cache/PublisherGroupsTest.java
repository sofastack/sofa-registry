...
public class PublisherGroupsTest {
    ...
    public void testPut() {
        ...
        DatumVersion v = groups
            .put(publisher.getDataInfoId(), Collections.singletonList(publisher));
        ...
        Assert.assertEquals(
            summaryMap.get(publisher.getDataInfoId()).getPublisherVersions()
                .get(publisher.getRegisterId()), publisher.registerVersion());
        ...
        Assert.assertEquals(
            summaryMap.get(publisher.getDataInfoId()).getPublisherVersions()
                .get(publisher.getRegisterId()), publisher.registerVersion());
        Assert.assertEquals(
            summaryMap.get(publisher2.getDataInfoId()).getPublisherVersions()
                .get(publisher2.getRegisterId()), publisher2.registerVersion());
    ...
    public void testUpdateRemove() {
        ...
        v = groups.put(publisher3.getDataInfoId(), Lists.newArrayList(publisher3));
        Assert.assertNotNull(v);
        v = groups.put(publisher1.getDataInfoId(),
            Lists.newArrayList(publisher1, publisher2, publisher4));
        Assert.assertNotNull(v);
        ...
        v = groups.remove(publisher2.getDataInfoId(),
        ...
        v = groups.remove(
            ...
            Collections.singletonMap(publisher1.getRegisterId() + "aa",
                publisher1.registerVersion()));
        Assert.assertNull(v);
        publishers = groups.getAllPublisher();
        Assert.assertEquals(publishers.size(), 2);
        Assert.assertEquals(publishers.get(publisher2.getDataInfoId()).size(), 2);
        ...
        v = groups.remove(publisher2.getDataInfoId(), publisher1.getSessionProcessId(),
        ...
        v = groups.remove(publisher2.getDataInfoId(), null,
            Collections.singletonMap(publisher1.getRegisterId(), publisher1.registerVersion()));
        Assert.assertNotNull(v);
        publishers = groups.getAllPublisher();
        Assert.assertEquals(publishers.size(), 2);

...
public class SessionDataStoreTest {
  ...
  public void testConcurrent() throws InterruptedException {
    SessionDataStore storeInstance = null;
    try {
      storeInstance = new SessionDataStore();
      SessionDataStore store = storeInstance;
      ...
      if (storeInstance != null) {
        storeInstance.shutdownWatchDog();
      }
    }
  }

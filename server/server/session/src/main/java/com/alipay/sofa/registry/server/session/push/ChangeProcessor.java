...
public class ChangeProcessor {
    ...
    boolean fireChange(String dataCenter, String dataInfoId, ChangeHandler handler,
    ...
    private static final class ChangeTask {
        ...
        ChangeTask(ChangeKey key, long expectDatumVersion, ChangeHandler changeHandler,
        ...
        public String toString() {
            return "ChangeTask{" + "key=" + key + ", version=" + expectDatumVersion + ", expire="
                   + expireTimestamp + ", deadline=" + expireDeadlineTimestamp + '}';
        }
    }
    ...
    private final class Worker extends WakeUpLoopRunnable {
        ...
        boolean commitChange(ChangeKey key, ChangeHandler handler, long expectDatumVersion) {
            synchronized (tasks) {
                ...
                final ChangeTask task = new ChangeTask(key, expectDatumVersion, handler,
                    now + changeDebouncingMillis);

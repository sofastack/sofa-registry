...
public class FirePushService {
  ...
  @Autowired private CacheService sessionCacheService;
  ...
  public boolean fireOnChange(String dataCenter, String dataInfoId, long expectVersion) {
    try {
      ...
      LOGGER.error(
          "failed to exec ChangeHandler {}, dataCenter={}, expectVer={}, {}",
          dataInfoId,
          dataCenter,
          expectVersion,
          e);
  ...
  public boolean fireOnRegister(Subscriber subscriber) {
    try {
      ...
      LOGGER.error(
          "failed to exec SubscriberTask {}, {}", subscriber.getDataInfoId(), subscriber, e);
      return false;
    }
  }

...
public final class RegisterLogs {
	public static final Logger REGISTER_LOGGER = LoggerFactory
			.getLogger("REGISTER");
	...
	public static void logError(BaseRegister register, String name,
		...
		if (e instanceof RequestChannelClosedException) {
			REGISTER_LOGGER.warn("{} register error, Type {}, {}", name,
					register.getEventType(), e.getMessage());
		} else {
			REGISTER_LOGGER.error("{} register error, Type {}", name,
					register.getEventType(), e);
		}
		registerResponse.setSuccess(false);
		registerResponse.setMessage(name + " register failed!Type:"
				+ register.getEventType());
	}

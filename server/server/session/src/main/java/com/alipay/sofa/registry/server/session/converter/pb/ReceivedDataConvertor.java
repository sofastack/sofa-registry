...
public class ReceivedDataConvertor {
    ...
    public static ReceivedData convert2Java(ReceivedDataPb receivedDataPb) {
        ...
        receivedData.setSubscriberRegistIds(ListStringConvertor.convert2Java(receivedDataPb
    ...
    public static ReceivedDataPb convert2Pb(ReceivedData receivedDataJava) {
        ...
        builder.setDataId(receivedDataJava.getDataId()).setGroup(receivedDataJava.getGroup())
            .setInstanceId(receivedDataJava.getInstanceId())
            .setLocalZone(receivedDataJava.getLocalZone()).setScope(receivedDataJava.getScope())
            .setSegment(receivedDataJava.getSegment()).setVersion(receivedDataJava.getVersion())
    ...
    public static ReceivedConfigDataPb convert2Pb(ReceivedConfigData receivedConfigData) {
        ...
        builder.setDataId(receivedConfigData.getDataId()).setGroup(receivedConfigData.getGroup())

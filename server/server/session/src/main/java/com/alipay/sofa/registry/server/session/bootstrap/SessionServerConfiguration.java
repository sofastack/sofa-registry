...
public class SessionServerConfiguration {
  ...
  public static class SessionCacheConfiguration {
    ...
    @Bean
    public CacheService sessionDatumRevisionsCacheService() {
      return new SessionDatumRevisionsCacheService();
    }
    ...
    @Bean(name = "com.alipay.sofa.registry.server.session.cache.DatumRevisionsKey")
    public CacheGenerator datumRevisionsCacheGenerator() {
      return new DatumRevisionsCacheGenerator();
    }
  ...
  public static class SessionProvideDataConfiguration {
    ...
    @Bean
    public FetchIncrementalPushSwitchService fetchIncrementalPushSwitchService(
        SystemPropertyProcessorManager systemPropertyProcessorManager) {
      FetchIncrementalPushSwitchService fetchIncrementalPushSwitchService =
          new FetchIncrementalPushSwitchService();
      systemPropertyProcessorManager.addSystemDataProcessor(fetchIncrementalPushSwitchService);
      return fetchIncrementalPushSwitchService;
    }
  }
}

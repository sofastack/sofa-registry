...
public final class PushTrace {
    ...
    private void calc() {
        ...
        final long lastPushTimestamp = subscriberPushedVersion <= ValueConstants.DEFAULT_NO_DATUM_VERSION ? 0
        ...
        this.firstPubPushDelayMillis = first == null ? 0 : pushFinishTimestamp
                                                           - first.getRegisterTimestamp();
        this.lastPubPushDelayMillis = last == null ? 0 : pushFinishTimestamp
                                                         - last.getRegisterTimestamp();
    }
    ...
    private List<SubPublisher> findNewPublishers(List<SubPublisher> publishers,
                                                 long minRegisterTimestamp) {
        ...
        news.sort(new Comparator<SubPublisher>() {
            @Override

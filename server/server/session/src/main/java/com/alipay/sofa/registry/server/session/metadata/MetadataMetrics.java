...
public class MetadataMetrics {
    ...
    static final class Fetch {
        static final Counter       METADATA_FETCH_COUNTER = Counter
                                                              .build()
                                                              .namespace("metadata")
                                                              .subsystem("fetch")
                                                              .name("metadata_fetch_total")
                                                              .help(
                                                                  "metadata query revision and apps")
                                                              .register();
    ...
    static final class Register {
        ...
        static final Counter       METADATA_REGISTER_COUNTER  = Counter
                                                                  .build()
                                                                  .namespace("metadata")
                                                                  .subsystem("register")
                                                                  .name("metadata_register_total")
                                                                  .help(
                                                                      "metadata revision register and heartbeat")
                                                                  .register();

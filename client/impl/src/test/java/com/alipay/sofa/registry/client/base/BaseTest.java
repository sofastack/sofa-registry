...
public abstract class BaseTest {
    ...
    public void setUp() throws Exception {
        ...
        when(
            HttpClientUtils.get(anyString(), anyMapOf(String.class, String.class),
                any(RegistryClientConfig.class))).thenReturn(
            mockServer.getIp() + ":" + mockServer.getPort());

        DefaultRegistryClientConfig config = DefaultRegistryClientConfigBuilder.start()
            .setAppName(appName).setDataCenter(dataCenter).setInstanceId(instanceId)
            .setRegistryEndpoint(mockServer.getIp()).build();

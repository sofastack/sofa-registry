...
public class AppPublisherBody {
     ...
     *
     */
    private List<AppPublisherBodyInterface>              interfaces;
    ...
    public List<AppPublisherBodyInterface> getInterfaces() {
        return interfaces;
    }

    public void setInterfaces(List<AppPublisherBodyInterface> interfaces) {
